...
export default function Home() {
  ...
  return <main>
    ...
    <div className="workspace">
      ...
      <aside className="side-panel"><MatchPanel night={night} setNight={setNight} disabled={!ready}/><section className="team-summary"><div className="eyebrow"><Trophy size={16}/> THE BIG PICTURE</div><h3>Team potential</h3><strong className="team-total">{teamMax.toLocaleString()}</strong><p>Combined best possible score<br/>for this game.</p><div className="potential-track"><span style={{width:`${teamMax/12}%`}}/></div><div className="range-labels"><span>0</span><span>1,200 PERFECT GAME</span></div><div className="summary-divider"/><div className="summary-row"><span>Team score so far</span><strong>{states.reduce((a,s)=>a+s.score,0)}</strong></div><div className="summary-row"><span>Games recorded</span><strong>{night.history.length}</strong></div></section>
    ...
    </div><footer><span>STRIKE CEILING</span><span>Made for the love of league night.</span></footer>
